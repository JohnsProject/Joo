...
public class JooCompilerTest {
	...
	public void compileTest() throws Exception {
		...
		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("10"));
		assertEquals(lines[line++], "" + JooVirtualMachine.TYPE_ARRAY_FIXED + (char)1);
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("5"));
		assertEquals(lines[line++], "" + JooVirtualMachine.TYPE_ARRAY_BOOL + (char)1);
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("15"));
		assertEquals(lines[line++], "" + JooVirtualMachine.TYPE_ARRAY_CHAR + (char)1);
		assertEquals(lines[line++], "" + charArray + jooCompiler.toByteCodeNumber("13"));
		...
		assertEquals(lines[line++], "" + int0 + JooVirtualMachine.OPERATOR_ADD + jooCompiler.toByteCodeNumber("100"));
		assertEquals(lines[line++], "" + int0 + JooVirtualMachine.OPERATOR_SUBTRACT + int1);
		assertEquals(lines[line++], "" + int0 + JooVirtualMachine.OPERATOR_MULTIPLY + jooCompiler.toByteCodeNumber("2"));
		assertEquals(lines[line++], "" + int0 + JooVirtualMachine.OPERATOR_DIVIDE + jooCompiler.toByteCodeNumber("10"));
		assertEquals(lines[line++], "" + int1 + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("6"));
		assertEquals(lines[line++], "" + fixed0 + JooVirtualMachine.OPERATOR_ADD + fixed1);
		assertEquals(lines[line++], "" + fixed0 + JooVirtualMachine.OPERATOR_SUBTRACT + jooCompiler.toByteCodeNumber("" + Math.round(0.5f * 255)));
		assertEquals(lines[line++], "" + fixed0 + JooVirtualMachine.OPERATOR_MULTIPLY + jooCompiler.toByteCodeNumber("" + Math.round(2.5f * 255)));
		assertEquals(lines[line++], "" + fixed0 + JooVirtualMachine.OPERATOR_DIVIDE + jooCompiler.toByteCodeNumber("" + Math.round(5f * 255)));
		assertEquals(lines[line++], "" + fixed1 + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("" + Math.round(50f * 255)));
		assertEquals(lines[line++], "" + bool0 + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("1"));
		assertEquals(lines[line++], "" + bool1 + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("0"));
		assertEquals(lines[line++], "" + bool2 + JooVirtualMachine.OPERATOR_ASSIGN + bool1);
		assertEquals(lines[line++], "" + char0 + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("65"));
		assertEquals(lines[line++], "" + char1 + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("66"));
		assertEquals(lines[line++], "" + char2 + JooVirtualMachine.OPERATOR_ASSIGN + char1);
		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("0") + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("30"));
		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("1") + JooVirtualMachine.OPERATOR_ADD + jooCompiler.toByteCodeNumber("15"));
		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("0") + JooVirtualMachine.OPERATOR_SUBTRACT + int1);
		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("1") + JooVirtualMachine.OPERATOR_DIVIDE + jooCompiler.toByteCodeNumber("5"));
		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("0") + JooVirtualMachine.OPERATOR_MULTIPLY + intArray + jooCompiler.toByteCodeNumber("1"));
//		assertEquals(lines[line++], "" + intArray + jooCompiler.toByteCodeNumber("7") + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("25"));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("0") + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("" + Math.round(60.5f * 255)));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("1") + JooVirtualMachine.OPERATOR_ADD + jooCompiler.toByteCodeNumber("" + Math.round(15f * 255)));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("0") + JooVirtualMachine.OPERATOR_SUBTRACT + fixed1);
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("1") + JooVirtualMachine.OPERATOR_DIVIDE + jooCompiler.toByteCodeNumber("" + Math.round(5f * 255)));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("0") + JooVirtualMachine.OPERATOR_MULTIPLY + fixedArray + jooCompiler.toByteCodeNumber("1"));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("2") + JooVirtualMachine.OPERATOR_ASSIGN_NEGATIVE + jooCompiler.toByteCodeNumber("" + Math.round(10f * 255)));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("3") + JooVirtualMachine.OPERATOR_ASSIGN_POSITIVE + fixedArray + jooCompiler.toByteCodeNumber("2"));
		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("4") + JooVirtualMachine.OPERATOR_ASSIGN_INVERSE + fixedArray + jooCompiler.toByteCodeNumber("3"));
//		assertEquals(lines[line++], "" + fixedArray + jooCompiler.toByteCodeNumber("5") + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("" + Math.round(25.25f * 255)));
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("9") + JooVirtualMachine.OPERATOR_ASSIGN + bool0);
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("10") + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("1"));
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("11") + JooVirtualMachine.OPERATOR_ASSIGN + boolArray + jooCompiler.toByteCodeNumber("10"));
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("2") + JooVirtualMachine.OPERATOR_ASSIGN_NEGATIVE + jooCompiler.toByteCodeNumber("1"));	
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("3") + JooVirtualMachine.OPERATOR_ASSIGN_POSITIVE + boolArray + jooCompiler.toByteCodeNumber("2"));	
		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("4") + JooVirtualMachine.OPERATOR_ASSIGN_INVERSE + boolArray + jooCompiler.toByteCodeNumber("3"));	
//		assertEquals(lines[line++], "" + boolArray + jooCompiler.toByteCodeNumber("5") + JooVirtualMachine.OPERATOR_ASSIGN + jooCompiler.toByteCodeNumber("1"));
		assertEquals(lines[line++], "" + charArray + jooCompiler.toByteCodeNumber("9") + JooVirtualMachine.OPERATOR_ASSIGN + char0);
