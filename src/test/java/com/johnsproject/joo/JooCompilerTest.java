...
public class JooCompilerTest {
	...
	public void compileTest() throws Exception {
		...
		assertEquals(jooLines[line++], "" + JooVirtualMachine.TYPE_BOOL + (char)4);
		...
		assertEquals(jooLines[line++], "" + JooVirtualMachine.TYPE_CHAR + (char)4);
		assertEquals(jooLines[line++], "" + char0);
		assertEquals(jooLines[line++], "" + char1 + 'A');
		assertEquals(jooLines[line++], "" + char2 + 'C');
		assertEquals(jooLines[line++], "" + JooVirtualMachine.TYPE_ARRAY_INT + (char)2);
		assertEquals(jooLines[line++], "" + intArray + (char)10);
		assertEquals(jooLines[line++], "" + JooVirtualMachine.TYPE_ARRAY_FIXED + (char)2);
		assertEquals(jooLines[line++], "" + fixedArray + (char)5);
		assertEquals(jooLines[line++], "" + JooVirtualMachine.TYPE_ARRAY_BOOL + (char)2);
		assertEquals(jooLines[line++], "" + boolArray + (char)15);
		assertEquals(jooLines[line++], "" + JooVirtualMachine.TYPE_ARRAY_CHAR + (char)2);
	...
	public void parseFunctionsTest() throws Exception {
		...
		assertEquals(start.getByteCodeName(), 16);
		...
		currentInstruction = start.getInstructions().get(currentInstructionIndex++);
		assertEquals(currentInstruction.isFunctionCall(), true);
		assertEquals(currentInstruction.getFunctionName(), "Print");
